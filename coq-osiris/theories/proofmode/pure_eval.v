...
Proof.
  intros Hm1 Hm2 Hk.
  unfold as_int.
  eapply pure_wp_Par_conseq. 1,2: eapply pure_as_int; eauto. 2: tauto.
...
Proof.
  ...
  eapply pure_wp_bind_conseq; eauto. intros ? (z & -> & Hz).
  eapply pure_enc_ret; eauto with encode.
Qed.
...
Proof.
  ...
  eapply pure_wp_simp; [ simp | eauto using pure_wp_ret ].
Qed.
